...
export const Register = () => {
  ...
  const handleSumbit = (e) => {
    e.preventDefault();
    axios
      .post(`https://witty-suit-tick.cyclic.cloud/user/register`, userData)
      .then((res) => {
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" onSubmit={handleSumbit}>
                ...
                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                  ...
                  <Link
                    to={"/login"}
                    className="font-medium text-primary-600 text-black hover:underline dark:text-primary-500"
                  >
                    Login here
                  </Link>
                </p>
